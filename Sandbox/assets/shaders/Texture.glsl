...
layout(location = 5) in int a_EntityID;//实体ID
...
layout(location = 1) out int color2;//颜色实体
...
layout (binding = 0) uniform sampler2D u_Textures[32];//采样器数组
